...
<body class="loggedin">
    <nav class="navtop">
        ...
        <a href="crud.php" style="color:white;"><i class="fas fa-cogs"></i>CRUD Casas</a>
        <a href="cerrar-sesion.php" style="color:red;"><i class="fas fa-sign-out-alt"></i>Cerrar Sesión</a>
    </nav>
    <div class="content">
