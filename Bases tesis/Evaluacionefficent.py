...
OUTPUT_DIR = r"C:\Users\Lenovo\Downloads\dia\evaluacion_modelo_efficentp1"
PDF_PATH = os.path.join(OUTPUT_DIR, "Reporte_Evaluacion_Modelo_efficentp1.pdf")
...
df_report.to_csv(os.path.join(OUTPUT_DIR, "reporte_metricas.csv"), encoding="utf-8-sig")
...
plt.tight_layout()
conf_path = os.path.join(OUTPUT_DIR, "matriz_confusion.png")
...
plt.title("Curvas ROC por Clase - EfficientNetV2B3")
...
# ==========================
# 6️⃣ Crear reporte en PDF
# ==========================
doc = SimpleDocTemplate(PDF_PATH, pagesize=letter)
styles = getSampleStyleSheet()
elements = []

elements.append(Paragraph("Evaluación del Modelo EfficientNetV2B3 (512x512)", styles["Title"]))
elements.append(Spacer(1, 12))

elements.append(Paragraph(
    "Este informe presenta los resultados de la evaluación del modelo EfficientNetV2B3 aplicado al diagnóstico automático de retinopatía diabética. "
    "Se incluyen métricas de precisión, recall, F1-score, la matriz de confusión y las curvas ROC por clase. "
    "Los datos fueron procesados utilizando imágenes de tamaño 512x512 píxeles, con un conjunto de validación del 20%.",
    styles["Normal"]
))
elements.append(Spacer(1, 12))
